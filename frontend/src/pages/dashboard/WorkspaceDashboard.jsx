    ...
    <div className="w-full max-w-6xl mx-auto py-5 px-4 sm:px-6 bg-[#ffffff]">
      ...
      {tasksLoading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12 select-none">
          ...
          <div className="lg:col-span-2 bg-[#f8fafc]/55 border border-blue-100/30 shadow-[0_25px_60px_-12px_rgba(37,99,235,0.38),0_0_20px_rgba(37,99,235,0.12)] rounded-3xl p-6 space-y-4">
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="bg-gradient-to-br from-[#2563eb] to-[#1d4ed8] text-white border border-[#1e40af] shadow-[0_25px_60px_-12px_rgba(37,99,235,0.42),0_0_20px_rgba(37,99,235,0.15)] rounded-3xl p-5 space-y-4">
                <div>
            ...
            <div>
              ...
              <div className="bg-[#f0f9ff]/80 border border-blue-200/40 shadow-[0_25px_60px_-12px_rgba(37,99,235,0.38),0_0_20px_rgba(37,99,235,0.12)] rounded-3xl p-5 space-y-3 max-h-[220px] overflow-y-auto pr-1">
                {workspace.members.map((memb, idx) => (
