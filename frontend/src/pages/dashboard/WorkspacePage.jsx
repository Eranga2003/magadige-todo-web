        ...
        {workspaces.length > 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {workspaces.map((ws) => (
                  <div
                    ...
                    className="bg-white border border-gray-150 rounded-2xl p-5 hover:shadow-md hover:border-blue-400/40 hover:-translate-y-0.5 transition-all duration-200 cursor-pointer flex flex-col justify-between group relative overflow-hidden h-[165px] shadow-xxs"
                  >
            ...
            <div className="space-y-4 select-none">
              <div className="bg-white border border-gray-150 rounded-2xl p-5 shadow-xxs space-y-4">
